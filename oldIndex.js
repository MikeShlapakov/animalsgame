...
const ballsImgs = {20: "../img1.png", 40: "../img2.png", 60: "../img3.png", 80: "../img4.png", 100: "../img5.png", 120: "../img6.png", 140: "../img7.png", 160: "../img8.png", 180: "../img9.png", 200: "../img10.png", 220: "../img11.png"}
...
function animate() {
    ...
    if (newBallLaunched && !isMouseDown){
        ...
        objects.push(new Circle((container.left + container.right)/2, 100, 20, 20, true, '../img1.png'));
    }
